...
from .layers import Conv3x3, ConvBlock, upsample, Cube2Equirec, Concat, BiProj, CEELayer, NormalHead
from . import spherical as S360
from collections import OrderedDict
import torch.nn.functional as F
# 导入球形填充相关的模块
from . import Utils
from .unifuse_weight_sphericalpad import fusion_ResNet
...
class UniFuse_weight(nn.Module):
    ...
    def __init__(self, num_layers, equi_h, equi_w, pretrained=False, #max_depth=10.0,
        ...
        self.cube_model = fusion_ResNet(
            bs*6, 18, ' ', (256, 256), 3, pretrained, padding='SpherePad')
        ...
        self.equi_dec_convs["normal_head"]=NormalHead(self.num_ch_dec[0])
    ...
    #def forward(self, input_equi_image, input_cube_image):
        ...
        # cube image encoding with spherical padding
        ...
        normal_map = self.equi_dec_convs["normal_head"](equi_x,1) 
        normal_map = torch.nn.functional.normalize(normal_map, p=2, dim=1)  # Normalize the output to unit vectors
        outputs["pred_normal"] = normal_map
