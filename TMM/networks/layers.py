...
class Cube2Equirec(nn.Module):
    ...
    def forward(self, cube_feat):
        ...
        assert h == self.face_w and w // 6 == self.face_w,f"Expected height to be {self.face_w}, and width to be {self.face_w * 6}, but got h={h}, w={w}"
        ...
        sample_grid = sample_grid.to(cube_feat.device)
